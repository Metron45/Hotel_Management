...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2019 at 08:04 AM
...
--
CREATE DATABASE IF NOT EXISTS `hotel_database` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `hotel_database`;
...
('root', '[{\"db\":\"hotel_database\",\"table\":\"credentials\"},{\"db\":\"hotel_database\",\"table\":\"hotel_info\"},{\"db\":\"hotel_database\",\"table\":\"reservations\"},{\"db\":\"hotel_database\",\"table\":\"client_info\"},{\"db\":\"hotel_database\",\"table\":\"Client_Info\"},{\"db\":\"hotel_database\",\"table\":\"Hotel_Info\"},{\"db\":\"hotel_database\",\"table\":\"Reservations\"},{\"db\":\"Hotel_database\",\"table\":\"Credentials\"}]');
...
('root', 'hotel_database', 'credentials', '{\"sorted_col\":\"`Account_Type` ASC\",\"CREATE_TIME\":\"2019-05-05 12:21:20\",\"col_order\":[0,1,2,3,4,5,6,7],\"col_visib\":[1,1,1,1,1,1,1,1]}', '2019-05-05 11:09:32');
...
('root', '2019-05-08 06:03:32', '{\"Console\\/Mode\":\"collapse\"}');
